...
class OFAMobileNetV3_BP(MobileNetV3_BP):
    ...
    def __init__(self, n_classes=1000, bn_param=(0.1, 1e-5), dropout_rate=0.1, base_stage_width=None,
        ...
        if depth_list is None:
            ...
            self.depth_list = [4, 4]
            print('Use MobileNetV3_BP Depth Setting')
        else:
    ...
    def config(self):
        return {
            'name': OFAMobileNetV3_BP.__name__,
    ...
    # TODO : aux classifiers option should be added!!! (gunju)
    def get_active_subnet(self, preserve_weight=True):
        first_conv = copy.deepcopy(self.first_conv)
        blocks = [copy.deepcopy(self.blocks[0])]
        aux_classifiers = [copy.deepcopy(self.aux_classifiers[0])]
    ...
    def get_active_net_config(self):
        ...
        #TODO : Dynamic Linear Layer Classifier support should be impl ! (gunju)
        aux_config_list = [self.aux_classifiers[0].config]
        ...
        for stage_id, block_idx in enumerate(self.block_group_info):
            ...
            aux_config_list += self.aux_classifiers[stage_id].config
        ...
        return {
            ...
            'aux_classifiers': aux_config_list,
        }
