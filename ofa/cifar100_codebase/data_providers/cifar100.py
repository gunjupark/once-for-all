...
from ofa.cifar100_codebase.data_providers.base_provider import DataProvider, MyRandomResizedCrop, MyDistributedSampler


class Cifar100DataProvider(DataProvider):
    DEFAULT_PATH = '/home/gunju/dataset/cifar100'
    ...
    def __init__(self, save_path=None, train_batch_size=256, test_batch_size=512, valid_size=None, n_worker=32,
        ...
        if not isinstance(self.image_size, int):
            ...
            from ofa.cifar100_codebase.data_providers.my_data_loader import MyDataLoader
